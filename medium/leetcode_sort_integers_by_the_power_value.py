...
class Solution:
    def getKth(self, lo: int, hi: int, k: int) -> int:
        ...
        def pow(i):
            ...
            j = i
            while i != 1:
                if i <= 1000 and cached[i] is not None:
                    step += cached[i]
                    break
                if i % 2 == 0:
                    i = i // 2
        ...
        array = [(CACHED[i], i) for i in range(lo, hi + 1)]
        array.sort()
        return array[k - 1][1]
...
def main():
    ...
    print(sol.getKth(10, 20, 5))
    print(sol.getKth(1, 1000, 777))
